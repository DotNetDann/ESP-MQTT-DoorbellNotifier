String GetDoorbellPic(bool Ringing) {
  ...
  String imgString = F("<svg enable-background='new 0 0 365.888 174.819' version='1.1' viewBox='0 0 365.89 174.82' xml:space='preserve' xmlns='http://www.w3.org/2000/svg' width='365.888px' height='174.819px'>");
  imgString += F("	<g fill='none' stroke-miterlimit='10'>");
  imgString += F("			<path d='m78.83 155.97c0 5.118-4.188 9.306-9.306 9.306h-52.114c-5.119 0-9.306-4.188-9.306-9.306v-139.59c0-5.118 4.187-9.306 9.306-9.306h52.114c5.118 0 9.306 4.188 9.306 9.306v139.59z' stroke='" + imgColor + "' stroke-width='1.8359'/>");
  imgString += F("			<path d='m73.477 150.27c0 4.507-3.687 8.196-8.195 8.196h-43.629c-4.509 0-8.196-3.689-8.196-8.196v-128.2c0-4.508 3.688-8.196 8.196-8.196h43.628c4.509 0 8.195 3.688 8.195 8.196v128.2z' stroke='" + imgColor + "' stroke-width='1.8359'/>");
  imgString += F("			<path d='m51.027 88.225c0.32-0.322 0.518-0.762 0.518-1.252 0-0.487-0.199-0.931-0.518-1.25' stroke='" + imgColor + "' stroke-width='1.3191'/>");
  imgString += F("			<path d='m52.276 89.475c0.642-0.642 1.036-1.525 1.036-2.502 0-0.976-0.395-1.86-1.036-2.5' stroke='" + imgColor + "' stroke-width='1.3191'/>");
  imgString += F("			<path d='m53.526 90.724c0.962-0.96 1.554-2.285 1.554-3.751s-0.592-2.792-1.554-3.752' stroke='" + imgColor + "' stroke-width='1.3191'/>");
  imgString += F("			<path d='m35.493 88.225c-0.319-0.322-0.518-0.762-0.518-1.252 0-0.487 0.202-0.931 0.518-1.25' stroke='" + imgColor + "' stroke-width='1.3191'/>");
  imgString += F("			<path d='m34.244 89.475c-0.641-0.642-1.035-1.525-1.035-2.502 0-0.976 0.395-1.86 1.035-2.5' stroke='" + imgColor + "' stroke-width='1.3191'/>");
  imgString += F("			<path d='m32.995 90.724c-0.961-0.96-1.555-2.285-1.555-3.751s0.594-2.792 1.555-3.752' stroke='" + imgColor + "' stroke-width='1.3191'/>");
  imgString += F("			<path d='m43.468 94.914c-0.811 0-1.485-0.581-1.638-1.346h-0.631c0.157 1.111 1.113 1.971 2.269 1.971 1.154 0 2.11-0.859 2.268-1.971h-0.631c-0.153 0.765-0.828 1.346-1.637 1.346z' stroke='" + imgColor + "' stroke-width='1.6145'/>");
  ...
  imgString += F("		<path d='m111.62 105.55c4.418-4.458 7.141-10.547 7.141-17.304 5e-3 -6.796-2.731-12.911-7.145-17.32' stroke='" + imgColor + "' stroke-width='1.8359'/>");
  imgString += F("		<path d='m128.91 122.84c8.866-8.891 14.326-21.104 14.333-34.596 6e-3 -13.545-5.458-25.774-14.339-34.628' stroke='" + imgColor + "' stroke-width='1.8359'/>");
  imgString += F("		<path d='m146.22 140.14c13.27-13.312 21.502-31.63 21.49-51.915 9e-3 -20.282-8.221-38.601-21.49-51.916' stroke='" + imgColor + "' stroke-width='1.8359'/>");
  imgString += F("	</g>"); 
  imgString += F("</svg>");
  return imgString;
}
